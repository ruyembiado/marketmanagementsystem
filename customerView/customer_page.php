...
<div class="row justify-content-center mx-0">
    ...
    <div class="col-md-12 text-center text-light px-5 pb-5 pt-2 mt-2 mb-3 rounded">
                                ...
                                <div class="card-info">
                                    ...
                                    <div class="form-group mx-1">
                                        <div class="row m-auto mx-5">
                                            <a class="btn btn-primary button-size btn-sm text-light" href="customer_view_market_product.php?view_market_prod=<?= $res2['market_ID'] ?>" role="button"><i class="fa fa-eye"></i> View</a>
                                        </div>
                                        <!-- <div class="row m-auto mx-5 mt-2">
                                            <a class="btn btn-primary text-light btn-sm button-size" href="customer_view_market_map.php?&market_ID=<?= $res2['market_ID'] ?>" role="button"><i class="fa fa-map"></i> Map</a>
                                        </div>   -->
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="card-info">
                                            ...
                                            <form action="" method="post">
                                                <div class="row d-flex justify-content-center align-items-center">
                                                    <a href="customer_store_view.php?view_stall=<?= $stall_ID ?>" role="button">
                            ...
                            <?php if (mysqli_num_rows($result3) > 0) {
                                ...
                                while ($res3 = mysqli_fetch_array($result3)) { ?>
                                    ...
                                    <div class="col-md-2 ms-4 mb-3 rounded" style="background-color: #708D81;">
                                        ...
                                        <div class="form-group">
                                            <div class="row m-auto mx-5">
                                                <a class="btn btn-primary text-light btn-sm button-size" href="customer_store_view.php?view_stall=<?= $res3['stall_ID'] ?>" role="button"><i class="fa fa-eye"></i> View</a>
                                            </div>
                                            <div class="row m-auto mx-5 mt-2">
                                                <a class="btn btn-primary text-light btn-sm button-size" href="customer_view_market.php?view_map=<?= $res3['stall_ID'] ?>&market_ID=<?= $res3['map_ID'] ?>" role="button"><i class="fa fa-map"></i> Map</a>
                                            </div>
                                        </div>
                                        </p>
                                    </div>
