...
<div class="row justify-content-center mx-0">
    <div class="col-md-11 p-4 text-center table-responsive-sm text-dark mt-3 mb-3 rounded" style="height: 700px; background-color: #708D81;">
        <div class="col-md-12 text-center mb-3">
            <h5 style="color: #001427;">My Reservation</h5>
        </div>
        <div class="d-flex align-items-center mb-2 float-end">
            <form action="customer_reservation.php" method="get">
        ...
        <table id="example" class="table table-striped account-table account-table-sm">
            <thead>
                <tr style="background-color: #F4D58D;">
                    ...
                    <!-- <th style="color: #001427;">Total Price</th> -->
            ...
            <tbody>
                ...
                if ($_GET['date_from'] && $_GET['date_to']) {
                    ...
                    $sql = "SELECT * FROM reservation, stall, product 
                            ...
                            AND reservation.customer_ID='$customer_ID' 
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td style="color: #001427;">
                            <a class="btn btn-primary text-light button-size " href="customer_reserve_view.php?view_reserve=<?php echo $reservation_date; ?>&status=all" role="button"><i class="fa fa-eye"></i> View</a>
                        </td>
                        </td>
                    </tr>
                <?php
