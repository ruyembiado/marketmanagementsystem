            ...
            ?>
                    <div class="col-md-12 rounded mb-3 text-center">
                        <div class="product-floor">
                            <p style="color: #F4D58D;" class="text-start">Products in Floor <?= $row['map_floor'] ?></p>
                            <hr class="hr text-secondary" />
                            <?php
                                                ...
                                                <div class="mx-3 mt-1 rounded d-flex justify-content-between px-3 py-2 align-items-center">
                                                    ...
                                                    <?php } else { ?>
                                                        <form action="../includes/customer.crud.php" method="post">
                                                            ...
                                                            <button name="add_reservation_market" class="rounded-circle bg-dark text-warning border-warning"><i class="fa fa-shopping-cart"></i></button>
                                                        </form>
                                                    <?php } ?>
                                                </div>
                                            </div>
