...
<div class="row justify-content-center mx-0">
    <div class="col-md-7 p-5 mt-4 text-dark rounded" style="background-color: #708D81; margin-bottom: 94px;">
        <div class="col-md-12 m-auto">
            <div class="d-flex align-items-center justify-content-center">
                <img class="img-fluid logo-user me-3" src="img/user-logo.png" style="height: 20%; width: 20%" />
                <p class="text-center" style="color: #001427; font-size:20px;">Register as Customer</p>
            </div>
        </div>
        <form action="includes/register.php" method="post">
            ...
            <div class="mb-3">
                <div class="row m-auto">
                    <input class="btn btn-primary text-light" type="submit" name="customer_reg" value="Register">
                </div>
            </div>
        </form>
    </div>
