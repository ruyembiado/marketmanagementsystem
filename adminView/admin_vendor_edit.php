        ...
        <form action="../includes/admin.crud.php" method="post">
            <div class="">
                <div class="form-group row">
                    <label>
                        <p class="text-center mb-0" style="font-size: 20px; color: #001427;">Update Vendor Profile</h5>
                    </label>
                </div>
                <?php
                ...
                <div class="form-group mb-1">
                    <div class="d-flex align-items-center">
                        ...
                        <label class="align-self-center ms-1"><i style="font-size:10px">check to update
                                password</i></label>
                    </div>
                </div>
                <div class="d-flex flex-row justify-content-evenly">
                ...
                <div class="form-group">
                    <div class="row m-auto">
                        ...
                        <input class="text-light button-size btn btn-primary" id="submitedit" type="submit" name="update_vendor" value="Update">
                    </div>
                </div>
            </div>
        </form>
