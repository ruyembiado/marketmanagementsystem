...
<div class="row justify-content-center mx-0">
    <div class="form-group mx-5">
        <div class="btn-group p-2">
            <a class="btn btn-primary text-light button-size px-4" href="admin_marketAd_acc.php" role="button"><i class="fa fa-arrow-left"></i> Back</a>
        </div>
    </div>
    <div class="col-md-5 p-5 mb-5 align-items-center justify-content-center text-light rounded" style="background-color: #708D81;">
        ...
        <form action="../includes/admin.crud.php" id="updateform" method="post">
            <div class="">
                <div class="form-group row">
                    <label>
                        <p style="color:#001427; font-size: 20px;" class="mb-0 text-center mt-2">Update Market Admin Profile</p>
                    </label>
                </div>

                <?php
                $market_admin_ID = $_GET['edit_marketAd'];
                $sql = "SELECT * FROM market_admin WHERE market_admin_ID ='$market_admin_ID'";
                ...
                <div class="form-group">
                    <div class="row m-auto">
                        ...
                        <input class="btn btn-primary button-size text-light" id="submitedit" type="submit" name="update_marketAd" value="Update">
                    </div>
                </div>
            </div>
        </form>
