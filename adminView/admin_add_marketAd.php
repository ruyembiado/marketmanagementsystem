...
<div class="row justify-content-center mx-0">
    ...
    <div class="col-md-5 p-5 mb-5 mt-3 text-light rounded" style="background-color: #708D81;">
        ...
        <form action="../includes/admin.crud.php" method="post">
            <div class="text-light">
                <div class="form-group row">
                    <label>
                        <p class="text-center mb-0" style="font-size: 20px; color: #001427;">Add Market Admin</p>
                    </label>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12 mb-0">
                        <select class="col-sm-12 mb-2 text-dark form-select" name="market_ID">
                ...
                <div class="form-group">
                    <div class="row m-auto">
                        <input class="btn btn-primary text-light button-size" type="submit" name="marketAd_add" value="Register">
                    </div>
                </div>
            </div>
        </form>
