...
@include '../config.php';
@include '../includes/vendor.session.php';
        ...
        <div class="sidebar pb-3" id="sidebar" style="overflow:hidden; background-color: #001427;">
            ...
            <div class="d-flex justify-content-start mt-2  mx-3 mb-4 ms-3 border-bottom border-secondary pb-3">
                ...
                <div class="ms-2 align-self-center">
                    <h6 class="mb-0 h6" style='color:#708D81; font-size:15px; '><span><?php echo $vendor_name; ?></span></h6>
                    <span style='color:#708D81; font-size:13px'>Vendor</span>
                </div>
            </div>
            <div class="row m-auto px-3 mb-3">
                <a href="vendor_page.php" class="side-admin btn text-start " style="color: #001427; background-color: #708D81;"><i class="fa fa-home" aria-hidden="true"></i> Dashboard
                </a>
            </div>
            <!-- <div class="row m-auto px-3 mb-3">
                <a href="vendor_market_list.php" class="side-admin btn text-start " style="color: #001427; background-color: #708D81;">                   <i class="fa fa-map" aria-hidden="true"></i> Market Map List
                </a>
            </div> -->
            <div class="row m-auto px-3 mb-3">
                <a href="vendor_stall.php" class="side-admin btn text-start " style="color: #001427; background-color: #708D81;"><i class="bi bi-shop-window" aria-hidden="true"></i> Manage Stalls
                </a>
            </div>
            <div class="row m-auto px-3 mb-3">
                <?php
                ...
                ?>
                <a href="vendor_customer_reservation.php?date_from=<?php echo $date; ?>&date_to=<?php echo date('Y-m-d', strtotime('+7 days')) ?>" class="side-admin btn text-start " style="color: #001427; background-color: #708D81;"><i class="fa fa-file-text" aria-hidden="true"></i> Manage Reservation
                </a>
            </div>
            </nav>
        </div>
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link d-flex" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-lg-inline-flex align-self-center" style='color:#708D81;'><?php echo $vendor_user; ?></span><i class="ms-1 fa fa-caret-down" style='color:#708D81;'></i>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end border-0 rounded-0 rounded-bottom m-0" style="color: #001427; background-color: #708D81;">
                            <a href="vendor_profile.php" style="color: #001427; background-color: #708D81;" class="dropdown-item">
